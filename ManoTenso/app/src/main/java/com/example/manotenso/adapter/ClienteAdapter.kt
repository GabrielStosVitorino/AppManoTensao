...
class ClienteAdapter(
    val listaCliente: MutableList<Cliente>,
    ...
    override fun onBindViewHolder(holder: ClienteAdapter.ClienteViewHolder, position: Int) {
        (holder as ClienteViewHolder).vincular(listaCliente[position])
    }
    ...
    inner class ClienteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun vincular(cliente: Cliente) {
            ...
            nomePrestador.text = cliente.nome
            var urlFoto: String? =
